...
export const en: Record<string, string> = {
  ...
  'settings.syncPreferenceGtd': 'GTD settings and defaults',
        ...
        'settings.quickAddWindowSize': 'Quick add window size',
        'settings.quickAddWindowSizeDesc': 'Size of the standalone quick-add popup.',
        'settings.quickAddWindowSizeCompact': 'Compact',
        'settings.quickAddWindowSizeDefault': 'Default',
        'settings.quickAddWindowSizeLarge': 'Large',
